...
Projeto desenvolvido com React e Redux para a resolução do exercício do módulo 30 do curso Desenvolvedor Full Stack Java. Página de empregos desenvolvida através do Fork do Github de um usuário, em seguida o Git Clone foi executada e as altereções no projeto foram realizadas.
